...
STAMMDATEIEN="server.js audit.js push.js sse.js scheduler.js planning-recurrence.js csv.js zeit.js abschluss.js totp.js geheimnis.js zweifaktor.js backup-krypto.js bestellrecht.js ausstellen.js .puppeteerrc.cjs package.json package-lock.json"
