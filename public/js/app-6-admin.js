...
const AUDIT_LABELS = {
  ...
  twofa_eigener_modus: 'Zwei-Faktor: eigenes Intervall geändert',
  twofa_scharf_code_falsch: 'Zwei-Faktor scharfschalten: falscher Code',
  avatar_ausschnitt: 'Profilbild-Ausschnitt geändert',
  backup_empfaenger_add: 'Sicherungs-Schlüssel hinzugefügt',
  backup_empfaenger_rename: 'Sicherungs-Schlüssel umbenannt',
  backup_empfaenger_remove: 'Sicherungs-Schlüssel entfernt',
  ...
  overtime_payout_create: 'Auszahlung angefragt',
  overtime_payout_signed: 'Auszahlung per Unterschrift',
  overtime_payout_confirm: 'Auszahlung bestätigt',
  overtime_payout_reject: 'Auszahlung abgelehnt',
  overtime_payout_withdraw: 'Auszahlung zurückgezogen',
  overtime_payout_auto_withdraw: 'Auszahlung beim Ausstellen zurückgezogen',
  product_category_create: 'Kategorie angelegt',
  product_create: 'Produkt angelegt',
  product_barcode_add: 'Barcode angelernt',
  product_barcode_remove: 'Barcode entfernt',
  product_update: 'Produkt geändert',
  product_delete: 'Produkt gelöscht',
  product_restore: 'Produkt wiederhergestellt',
  product_purge: 'Produkt endgültig gelöscht',
  product_merge: 'Produkte zusammengeführt',
  product_category_update: 'Produkt-Kategorie umbenannt',
  product_category_merge: 'Produkt-Kategorien zusammengeführt',
  product_category_delete: 'Produkt-Kategorie gelöscht',
  project_category_create: 'Auftrags-Kategorie angelegt',
  project_category_rename: 'Auftrags-Kategorie umbenannt',
  project_category_delete: 'Auftrags-Kategorie gelöscht',
  ...
  supplier_purge: 'Großhändler endgültig gelöscht',
