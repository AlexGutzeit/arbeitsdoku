...
|---|---|
| **🏠 Willkommen** | Persönliches Dashboard: anstehende Planung, eigene Abwesenheiten, Schnellüberblick. **Wetter** zum Firmenort (aus *Einstellungen → Firmen-Einstellungen*): aktuelle Lage, Tagesverlauf und eine **7-Tage-Vorschau** mit je **früh / mittag / abend** (Symbol, Temperatur, Regenwahrscheinlichkeit). Ohne hinterlegten Ort erscheint statt des Wetters ein Hinweis. |
