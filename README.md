...
|---|---|
| **🏠 Willkommen** | Persönliches Dashboard: anstehende Planung, eigene Abwesenheiten, Schnellüberblick. **Wetter** zum Firmenort (aus *Einstellungen → Firmen-Einstellungen*): aktuelle Lage, stündlicher Tagesverlauf und eine **16-Tage-Vorschau** mit je **früh / mittag / abend** (Symbol, Temperatur, Regenwahrscheinlichkeit). Die **ersten 7 Tage** lassen sich **antippen** und zeigen dann ihren **stündlichen** Verlauf – so weit reichen die hochauflösenden Modelle; danach bleibt es bei den groben Blöcken, darüber hinaus gibt es keine Vorhersagedaten. Ohne hinterlegten Ort erscheint statt des Wetters ein Hinweis. |
