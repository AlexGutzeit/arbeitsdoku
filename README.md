...
**Grenze der Automatik:** Die Werte folgen dem Arbeitszeitgesetz und gelten damit für Erwachsene. Für **Auszubildende unter 18** gilt das Jugendarbeitsschutzgesetz mit längeren Pausen (60 Minuten ab 6 Stunden). Die App kennt kein Geburtsdatum und kann das nicht unterscheiden — sie sagt es deshalb im Hinweis und in den Einstellungen, statt es stillschweigend zu übergehen. Keine Rechtsberatung; Tarifverträge können abweichen. Nettostunden werden automatisch berechnet; überlappende Einträge werden nicht doppelt gezählt. |
