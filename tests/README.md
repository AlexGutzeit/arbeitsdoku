...
**234 Tests.** Die Beschreibung ist jeweils die erste Kommentarzeile der Datei.
...
| `rueckspielen-abbruch.js` | Zurückspielen, das mittendrin scheitert: danach gilt eindeutig der alte Stand (R3, 25.09.2026). |
...
| `verstoesse-uebersicht-ui.js` | Gesetzesverstöße in den Übersichten des Zeitnachweises (Alex, 26.08.2026) |
| `warn-schalter-ui.js` | Warnungen für sich selbst ausblenden (Alex, 26.08.2026) |
| `wetter-heute-ui.js` | Die Wetterkarte zeigte den heutigen Tag ZWEIMAL (Alex, 30.07.2026). |
| `willkommen-avatare-ui.js` | Profilbilder in der Wochenliste der Willkommensseite (Alex, 31.08.2026). |
