...
(async () => {
  ...
  try {
    ...
    const anna = (await req('POST','/api/users', admin, { username:'anna', password:'test', name:'Anna Berg', role:'mitarbeiter', hours_mon:8,hours_tue:8,hours_wed:8,hours_thu:8,hours_fri:8 })).body.user;
